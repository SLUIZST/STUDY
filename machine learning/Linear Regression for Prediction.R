...
# TIP
# Compute accuracy by fitting logistic regression y~x using train dataset and predict.glm on 
# test dataset (be sure to set type='response'). Probabilities will be returned. Lets say 
# you call this vector p_y. Code y_hat <- ifelse(p_y>=0.5, 1,0). The rest follows.
